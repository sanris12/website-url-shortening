...
<div class="flex flex-col gap-2 lg:items-center lg:flex-row ">
  ...
  <button data-shortlink="${shortLink}" class="btn-copy-link text-lg text-white font-poppins bg-cyan rounded-md hover:bg-opacity-80 active:scale-95 transition duration-200 py-1.5 mx-5 lg:px-10 active:bg-darkviolet">
    copy
  </button>
</div>`);
}

function removePopupCopied() {
  setTimeout(function () {
